...
class WindWakerOnline implements IPlugin, IWWOnlineHelpers, IPluginServerConfig {
    ...
    onTick(frame?: number | undefined): void {
        const commandBufferHook = Buffer.from([0x49, 0x5C, 0xB4, 0x08]);
        const sceneChangeHook = Buffer.from([0x49, 0x7A, 0xC8, 0x70]);
        const commandBufferFunc = Buffer.from(
            []
        );
